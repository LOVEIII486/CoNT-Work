...
from model.m2trGen import M2TrGenModel
...
def parse_args():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='data/iu_xray/images/',#/data/user/jiangzw/iu_xray/images/
                        help='the path to the directory containing the data.')#/data/user/jiangzw/iu_xray/annotation.json
    parser.add_argument('--ann_path', type=str, default='data/iu_xray/annotation.json',#/data/user/jiangzw/iu_xray/front_slide.json
    ...
    parser.add_argument('--front_or_slide_path',default='data/iu_xray/front_slide.json')
    ...
    parser.add_argument('--saliency_model_path', default="./best_model.pth.tar", type=str,
...
def main():
    ...
    val_dataloader = R2DataLoader(args, tokenizer, split='val', shuffle=True)
    test_dataloader = R2DataLoader(args, tokenizer, split='test', shuffle=True)
